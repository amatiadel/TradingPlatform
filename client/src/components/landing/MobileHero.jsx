...
const MobileHero = ({ onCreateAccount }) => {
         ...
         {isMobileMenuOpen && (
           <div className="mobile-menu">
             <div className="mobile-nav">
               <a href="#trading" className="mobile-nav-link">Trading</a>
      ...
      <div className="hero-content-centered">
        <div className="hero-text-centered">
          <h1 className="hero-headline-centered">
            ...
            <span>with every single trade</span>
          </h1>
          <div className="hero-cta-centered">
            <button onClick={onCreateAccount} className="btn-start-now">
              Start now for $0
            </button>
        ...
        <div className="feature-badges-inside">
          <div className="badge">
            <img src="/assets/landing/fire.webp" alt="Modern platform" className="badge-icon" />
            <span className="badge-text">Modern platform</span>
          </div>
          <div className="badge">
            <img src="/assets/landing/love.webp" alt="Useful features" className="badge-icon" />
            <span className="badge-text">Useful features</span>
          </div>
          <div className="badge">
            <img src="/assets/landing/finish.webp" alt="Easy start" className="badge-icon" />
            <span className="badge-text">Easy start</span>
          </div>
          <div className="badge">
            <img src="/assets/landing/books.webp" alt="Learning center" className="badge-icon" />
            <span className="badge-text">Learning center</span>
          </div>
          <div className="badge">
            <img src="/assets/landing/money.webp" alt="Quick withdrawals" className="badge-icon" />
            <span className="badge-text">Quick withdrawals</span>
          </div>
          <div className="badge">
            <img src="/assets/landing/shield.webp" alt="Trusted broker" className="badge-icon" />
