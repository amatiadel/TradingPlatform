          ...
          <div style={{ marginBottom: '30px' }}>
            ...
            <input
              ...
              style={{
                ...
                padding: '12px',
                background: 'rgba(255, 255, 255, 0.1)',
                border: password !== confirmPassword && confirmPassword ? '1px solid #ff4444' : '1px solid rgba(255, 255, 255, 0.2)',
                borderRadius: '6px',
                color: 'white',
                fontSize: '16px',
                boxSizing: 'border-box'
            ...
            {password !== confirmPassword && confirmPassword && (
             ...
             style={{
               width: '100%',
               padding: '14px',
               background: (isLoading || password !== confirmPassword) ? '#666' : 'linear-gradient(135deg, #0066ff 0%, #00ff88 100%)',
               border: 'none',
               borderRadius: '6px',
